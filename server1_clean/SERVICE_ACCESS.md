...
- Realm metadata: `http://10.155.38.139:8090/realms/master/.well-known/openid-configuration`
- Token endpoint: `http://10.155.38.139:8090/realms/master/protocol/openid-connect/token`
- Login:
  - Username: `dataplatform`
  - Password: `Dataplatform@123`
- Notes:
  - Use the direct HTTP endpoint on `8090`
  - The older HTTPS proxy path on `8443` is no longer the supported access path
